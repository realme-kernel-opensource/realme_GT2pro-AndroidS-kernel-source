...
#include "oplus_battery_msm7225_R.h"
		...
		union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_TEMP:
		...
		/* BSP.Kernel.Stability,2020/11/12,add force temperature 25 for power on */
		val->intval = DEBUG_ACCESSORY_TEMP_DECIDEGC;
		break;
