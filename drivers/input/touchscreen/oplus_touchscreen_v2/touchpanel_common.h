...
struct touchpanel_data {
	...
	bool touch_v2_switch_support;                       /*indicate touch_v2 switch support or not*/
	...
	int touch_v2;                                    /*for touch_v2 mode control*/
